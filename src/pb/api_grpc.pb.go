...
func (c *apiClient) GetStatisticsCitizens(ctx context.Context, in *GetStatisticsCitizensRequest, opts ...grpc.CallOption) (*GetStatisticsCitizensResponse, error) {
	out := new(GetStatisticsCitizensResponse)
	err := c.cc.Invoke(ctx, "/citizenv.Api/GetStatisticsCitizens", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Api_GetStatisticsCitizens_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetStatisticsCitizensRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiServer).GetStatisticsCitizens(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/citizenv.Api/GetStatisticsCitizens",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiServer).GetStatisticsCitizens(ctx, req.(*GetStatisticsCitizensRequest))
	}
	return interceptor(ctx, in, info, handler)
}
